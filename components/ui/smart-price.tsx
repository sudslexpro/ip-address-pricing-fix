...
interface SmartPriceProps {
	...
	/** Enable automatic IP-based currency detection */
...
/**
 * SmartPrice - A versatile component for automatic currency conversion based on IP geolocation
 *
 * Features:
 ...
 */
const SmartPrice: React.FC<SmartPriceProps> = ({
	amount,
	className,
	prefix,
	suffix,
	...
	// Use the existing currency conversion hook
	const {
		userLocation,
		exchangeRate,
		currentCurrency,
		...
		return (
			<span className="inline-flex items-center gap-1">
				...
				{showLocationIndicator && userLocation && isConverted && (
					<span
						title={`Auto-detected from ${userLocation.countryName}`}
			...
			<Popover>
				...
				<PopoverContent className="w-80">
					<div className="space-y-4">
						<h4 className="font-medium">Price Rounding Settings</h4>
